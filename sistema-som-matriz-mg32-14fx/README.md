...
| **Caixas laterais sem som, caixas grandes funcionam** | Botão **PRE inferior** e fader | O **botão PRE inferior** (entre AUX 4 e AUX 5/6) pode estar **APERTADO** acidentalmente, tornando o AUX 4 independente do fader. Mantenha-o **SOLTO**. Verifique também se o botão azul **AUX 4** do canal está girado para a direita. |
