...
set "NODEJS_DIRECTORY=%UserProfile%\Downloads\NodeJS"


if exist "%NODEJS_DIRECTORY%" goto :end
...
"%ORIGINAL%\Programs\wrar\WinRAR.exe" x -o+ "%ORIGINAL%\Programs\nodejs.7z" "%UserProfile%\Downloads\"
...
rem pause
title NodeJS Setup - Took %hh%:%mm%:%ss%,%cc% seconds to run this script
timeout /T 60
endlocal
